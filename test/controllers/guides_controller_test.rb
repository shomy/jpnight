...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post guides_url, params: { guide: { mail: @guide.mail, name: @guide.name, tel: @guide.tel } }
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { mail: @guide.mail, name: @guide.name, tel: @guide.tel } }
